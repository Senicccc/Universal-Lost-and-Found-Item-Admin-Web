...
class UserApiController extends ApiController
{
    public function register(Request $request)
    {
        ...
        return $this->jsonSuccess(['user' => $user, 'api_token' => $user->api_token], 201);
    }
    ...
    public function login(Request $request)
    {
        ...
        return $this->jsonSuccess(['user' => $user, 'api_token' => $user->api_token]);
    }
    ...
    public function show($id)
    {
        ...
        if (!$user) return $this->jsonError('Not found', 404);
